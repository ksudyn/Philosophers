...
/*   Updated: 2026/06/24 16:47:21 by ksudyn           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// --track-origins=yes --log-file=valgrind.log ./philo_bonus 5 800 200 200 3

// Explicación rápida de las opciones:

// --leak-check=full
//		-> comprueba todos los leaks.

// --show-leak-kinds=all 
//		-> muestra todos los tipos de fuga (definitivas, posibles…).

// --track-origins=yes
//		-> ayuda a encontrar dónde se originan los punteros inválidos.

// --log-file=valgrind.log
//		-> guarda el resultado en un archivo para revisarlo cómodamente.
